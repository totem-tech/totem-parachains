...
# ./target/release/totem-parachain-collator build-spec --chain ./res/stagex/stagex-parachain-readable-fix.json --raw > ./res/stagex/stagex-parachain-raw-fix.json && \
...
# ./target/release/totem-parachain-collator export-genesis-wasm --chain ./res/stagex/stagex-parachain-raw-fix.json > ./res/stagex-parachain-genesis-wasm-fix.wasm
...
# ./target/release/totem-parachain-collator export-genesis-state --chain ./res/stagex/stagex-parachain-raw-fix.json > ./res/stagex/stagex-genesis-state-fix.state && \
